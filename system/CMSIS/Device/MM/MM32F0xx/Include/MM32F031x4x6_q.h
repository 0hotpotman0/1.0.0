...
#define SPI_INTEN_UNDERRUN_IEN ((uint16_t)0x0004) /*!<  Transmitter underrun interrupt enable bit锟斤拷SPI slave mode only锟斤拷*/
...
#define SPI_INTCLR_UNDERRUN_ICLR ((uint16_t)0x0004) /*!<  Transmitter underrun interrupt clear bit锟斤拷SPI slave mode only锟斤拷*/
