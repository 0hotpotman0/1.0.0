...
{	
	...
	{ GPIOA, 14,  RCC_AHBPeriph_GPIOA, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_50MHz, GPIO_AF_1 }, // 7  : TX.mp3-Serial
	...
	{ GPIOA,  5,  RCC_AHBPeriph_GPIOA, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_50MHz, GPIO_AF_0 }, // 11 : ADC/SCK, DATA of DHT11.
	{ GPIOA,  6,  RCC_AHBPeriph_GPIOA, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_50MHz, GPIO_AF_0 }, // 12 : ADC/MISO Jim_XU change it from GPIO_AF_0 for PA6
	{ GPIOA,  7,  RCC_AHBPeriph_GPIOA, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_50MHz, GPIO_AF_0 }, // 13 : ADC/MOSI Jim_XU change it from GPIO_AF_0 for PA7
...
extern const TIM_TypeDef* pin_TIM[]=
{
	...
	NULL,          // 8
	NULL,          // 9
	TIM14,         // 10 Jim_XU change it from TIMl4 to NULL for PA4
	NULL,          // 11
	NULL,          // 12 Jim_XU change it from NULL for PA6
	NULL,          // 13 Jim_XU change it from NULL for PA7
	TIM3,          // 14
	NULL
};
...
extern const uint16_t pin_TIM_Channel[]=
{
	...
	NONE, 		   // 8
	NONE, 		   // 9
	TIM_Channel_1, // 10 Jim_XU change it from TIM_Channel_1(Ultrasonic) to NONE for PA4
	NONE, 		   // 11
	NONE, // 12 Jim_XU change it from NONE for PA6
	NONE, // 13 Jim_XU change it from NONE for PA7
	TIM_Channel_4, // 14
	NONE
};
